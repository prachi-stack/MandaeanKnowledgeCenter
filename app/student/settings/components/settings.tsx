    ...
    <div className="px-4 sm:px-6 md:px-10 py-8 mx-4">
      ...
      <Tabs defaultValue="profile" className="w-full">
        <TabsList className="flex space-x-6 shadow-none border-none rounded-none">
          <TabsTrigger
            value="profile"
            className="relative pb-2 text-gray-500 data-[state=active]:text-sky-600 after:absolute after:left-0 after:right-0 after:-bottom-0.5 after:h-0.5 after:bg-sky-600 after:scale-x-0 data-[state=active]:after:scale-x-100 after:transition-transform after:origin-left shadow-none focus:ring-0 focus:ring-offset-0 focus:outline-none "
          >
            Profile
          </TabsTrigger>
          <TabsTrigger
