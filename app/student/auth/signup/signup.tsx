    ...
    <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          <Button type="submit" className="w-full bg-blue-600 text-white font-semibold py-5" onClick={switchToLogin}>
            Sign up
          </Button>
        </form>
      </Form>
      ...
      <div className="flex mt-2">
        <p className="text-sm text-[#5A7184]">
          ...
          <Button type="button" variant="link" className="text-blue-600 font-medium p-0" onClick={switchToLogin}>
            Sign In
          </Button>
        </p>
      </div>
