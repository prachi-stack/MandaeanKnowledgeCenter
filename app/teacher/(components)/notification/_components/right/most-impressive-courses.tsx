...
export default function MostImpressiveCourses() {
  return (
    <div className="rounded-lg">
      <div className="mb-4">
        <h2 className="text-lg text-neutral-800 font-semibold">Most Impressive Course</h2>
      </div>
      <div className="space-y-4">
        {courses.map((course) => (
          <div key={course.id} className="flex items-center space-x-3">
            ...
            <p className="text-xs font-medium text-neutral-700">{course.title}</p>
            </div>
             
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-1 text-xs text-[#3F3F4466]">
