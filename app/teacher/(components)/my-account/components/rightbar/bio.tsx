  ...
  return (
    <div className='space-y-3 p-6 bg-[#F7F7F7B2] rounded-lg'>
        ...
        <div className='flex items-center justify-between'>
            <Badge className='bg-emerald-100 text-emerald-500 py-2'>Designer</Badge>
            <Badge className='bg-emerald-100 text-emerald-500 py-2'>Figma</Badge>
            <Badge className='bg-emerald-100 text-emerald-500 py-2'>Web Design</Badge>
        </div>
    </div>
  )
}
