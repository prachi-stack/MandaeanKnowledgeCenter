...
export default function NotificationTab() {
    ...
    return (
        <div className=" space-y-15 sm:space-y-6 mt-6">
            <div className="flex flex-col sm:flex-row gap-[3rem] sm:gap-[6rem]">
                <div>
                    ...
                    <div className="space-y-4">
                        <h2 className="font-semibold text-2xl">Send me email notifications:</h2>
                        <RadioGroup defaultValue="never">
                            <div className="flex items-center space-x-2">
                                <RadioGroupItem value="all" id="r1" className="border-2 border-gray-600 data-[state=checked]:border-sky-600 data-[state=checked]:text-sky-600" />
                                <Label htmlFor="r1" className="font-normal">Send me email notifications</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                                <RadioGroupItem value="hourly" id="r2" className="border-2 border-gray-600 data-[state=checked]:border-sky-600 data-[state=checked]:text-sky-600" />
                ...
                <div>
                    ...
                    <RadioGroup>
                        <div className="flex space-x-2">
                            <RadioGroupItem value="secure" id="s1" className="border-2 border-gray-600 data-[state=checked]:border-sky-600 data-[state=checked]:text-sky-600 " />
                            <div>
                        ...
                        <div className="flex space-x-2">
                            <RadioGroupItem value="standard" id="s2" className="border-2 border-gray-600 data-[state=checked]:border-sky-600 data-[state=checked]:text-sky-600" />
                            <div>
                                <Label htmlFor="s2" className="font-medium">Standard</Label>
                                <p className="text-gray-500">Receive an email when someone signs in from a new location, with an unrecognized device.</p>
                            </div>
                        </div>
                        <div className="flex space-x-2">
                            <RadioGroupItem value="none" id="s3" className="border-2 border-gray-600 data-[state=checked]:border-sky-600 data-[state=checked]:text-sky-600" />
            ...
            <div>
                ...
                <p className=" max-w-2xl mb-7 text-gray-500">
            ...
            <div className="max-w-2xl text-gray-500 space-y-4 pt-6 pb-3">
                <p>
            ...
            <div className="flex gap-4 items-center justify-center">
                <Button variant="outline" size="sm" className="border-gray-200 rounded:lg">Discard</Button>
...
function CheckboxItem({ label }: { label: string }) {
    ...
    return (
        <div className="flex items-center space-x-2">
            <Checkbox id={id} className="border-2 border-gray-500 data-[state=checked]:bg-sky-600 data-[state=checked]:border-sky-600 data-[state=checked]:text-white data-[state=checked]:font-semibold" defaultChecked />
