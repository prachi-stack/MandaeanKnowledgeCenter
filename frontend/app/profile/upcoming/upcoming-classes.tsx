...
const ClassesInfo: upcomingclass[] = new Array(6).fill({
        badge: 'Marketing',
        time: '2 hours',
        title: 'Digittal Marketing Essentials',
        ...
        {ClassesInfo.map((classInfo, index) => (
            <div className="">
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <Button size="sm" className="bg-blue-600 sm:px-4">Notify Me</Button>
                </div>
             </div>
            ))}
     </div>
