...
const navlinks: navLink[] = [
    ...
    { name: "My Learning", path: "/student/my-learning" },
];
        ...
        <div>
            <header className="w-full">
                ...
                <div className="w-full">
                    <Image src="/authbg.png" alt="beforelogin" width={1200} height={400} className="" />
                </div>
                <div className="bg-white p-8 rounded-xl shadow-md w-full flex items-center justify-center -mt-50">
                        ...
                        {view === 'signup' && <RegisterForm onSwitch={() => setView('login')} />}
